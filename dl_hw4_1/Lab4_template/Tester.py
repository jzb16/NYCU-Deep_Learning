...
class Test_model(VAE_Model):
    ...
    def eval(self):
        ...
        for idx, (img, label) in enumerate(tqdm(val_loader, ncols=80)):
            ...
            pred_seq_list.append(pred_seq.cpu())
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        decoded_frame_list = [img[0].to(self.args.device)]
        label_list = []
        ...
        for t in range(1, 630):
            ...
            output_img = self.forward(current_frame, current_label)
            decoded_frame_list.append(output_img)
            label_list.append(current_label)
            current_frame = output_img.detach()
